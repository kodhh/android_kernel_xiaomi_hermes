...
// kern < 3.11 use void* for filldir_t first arg, 3.11+ uses struct dir_context*
#if LINUX_VERSION_CODE < KERNEL_VERSION(3, 11, 0)
#define KSU_FILLDIR_CTX void
#else
#define KSU_FILLDIR_CTX struct dir_context
#endif

FILLDIR_RETURN_TYPE my_actor(KSU_FILLDIR_CTX *ctx, const char *name,
