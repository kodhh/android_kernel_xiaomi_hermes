...
{
	return q1->len == q2->len && str_n_case_eq((const char *)q1->name, (const char *)q2->name, q2->len);
}

#define QSTR_LITERAL(string) QSTR_INIT((const unsigned char *)string, sizeof(string)-1)
