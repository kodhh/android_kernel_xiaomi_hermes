...
int sanity_check_ckpt(struct f2fs_sb_info *sbi)
{
	...
	unsigned int segment_count_main, main_segs;
	...
	if (!user_block_count || user_block_count >=
			segment_count_main << sbi->log_blocks_per_seg) {
		f2fs_msg(sbi->sb, KERN_ERR,
