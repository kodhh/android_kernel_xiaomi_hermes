...
static int cifs_ci_hash(const struct dentry *dentry, const struct inode *inode, struct qstr *q)
{
...
static int cifs_ci_compare(const struct dentry *parent, const struct inode *pinode,
		const struct dentry *dentry, const struct inode *dinode,
