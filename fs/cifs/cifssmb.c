...
/* cifs_mark_open_files_invalid moved to misc.c */
...
/* discard_remaining_data, cifs_readv_discard, cifs_readv_receive moved to transport.c */
...
/* cifs_writedata_release moved to file.c */
